...
class CoLA(DeepDetector):
    ...
    **kwargs
    ...
    def forward_model(self, data,train=True,visualize=False,label=None,fig_title=None):
        ...
        logits = torch.cat([pos_logits[data.active_mask][:batch_size],
                            neg_logits[data.active_mask][:batch_size]])
        n_pos_logits = len(pos_logits[data.active_mask][:batch_size])
        n_neg_logits = len(neg_logits[data.active_mask][:batch_size])
        ...
        score = neg_logits[data.active_mask][:batch_size] - pos_logits[data.active_mask][:batch_size]
