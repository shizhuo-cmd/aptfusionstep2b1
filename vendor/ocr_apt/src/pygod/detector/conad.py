...
class CONAD(DeepDetector):
    ...
    **kwargs : optional
    ...
    def forward_model(self, data):
        ...
        score = self.model.loss_func(x[data.active_mask, :][:batch_size],
                                     x_[data.active_mask, :][:batch_size],
                                     s[data.active_mask, :][:batch_size, node_idx],
                                     s_[data.active_mask, :][:batch_size],
                                     self.weight)
