...
class OCGNN(OCRAPT_DeepDetector):
    """
    ...
    **kwargs
    ...
    def validate_model(self, data, visualize=False,fig_title=None):
        ...
        early_stop = self.model.loss_func_val(emb[data.val_mask, :], label=data.y[data.val_mask], threshold = current_threshold, visualize=visualize,
                                 fig_title=fig_title)
        return early_stop
