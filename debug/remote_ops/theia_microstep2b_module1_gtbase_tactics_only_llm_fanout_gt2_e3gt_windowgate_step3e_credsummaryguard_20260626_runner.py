...
REUSED_SOURCE_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_step3b_payloadtimelinepriv_offset240_20260626"
)
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_step3e_credsummaryguard_offset240_20260626"
)
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "theia_behavior_capture_windowgate_step3e_credsummaryguard_20260626"
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step3e_credsummaryguard",
