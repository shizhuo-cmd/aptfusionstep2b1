...
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_headcontrol_offset240_20260628"
)
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "theia_behavior_capture_headcontrol_20260628"
...
def _working_tree_fingerprint() -> dict[str, Any]:
    ...
    return {
        "code_baseline": "head_control_without_step1_patch",
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "headcontrol_without_step1_patch_20260628",
