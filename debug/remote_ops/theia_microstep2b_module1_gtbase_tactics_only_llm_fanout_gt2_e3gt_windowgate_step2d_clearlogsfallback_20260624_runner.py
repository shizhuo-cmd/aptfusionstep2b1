...
REUSED_SOURCE_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_step2b_browsercredguard_offset240_20260624"
)
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_step2d_clearlogsfallback_offset240_20260624"
)
GT_JSON_PATH = resolve_attack_eval_gt_json(REPO_ROOT)
GT_TIME_OFFSET_MINUTES = 240
REUSED_DIR_NAMES = ["module5_paths"]
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "theia_behavior_capture_windowgate_step2d_clearlogsfallback_20260624"
...
def _prepare_reused_artifacts(target_root: Path) -> dict[str, Any]:
    ...
    for name in REUSED_DIR_NAMES:
        _link_dir(REUSED_SOURCE_ROOT / name, target_root / name)
    return {
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step2d_clearlogsfallback",
