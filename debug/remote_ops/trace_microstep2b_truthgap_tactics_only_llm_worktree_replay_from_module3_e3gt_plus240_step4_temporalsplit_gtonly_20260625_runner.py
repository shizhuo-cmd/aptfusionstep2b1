...
REUSED_SOURCE_ROOT = (
    REPO_ROOT / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_step3_objecttransfer_gtonly_20260617"
)
TARGET_ROOT = (
    REPO_ROOT
    / (
        "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_worktree_"
        "replay_from_module3_e3gt_plus240_step4_temporalsplit_gtonly_20260625"
    )
)
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "trace_behavior_capture_step4_temporalsplit_20260625"
