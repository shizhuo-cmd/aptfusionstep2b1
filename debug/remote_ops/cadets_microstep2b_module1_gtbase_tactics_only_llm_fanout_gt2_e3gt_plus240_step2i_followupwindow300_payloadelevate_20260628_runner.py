...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "cadets_behavior_capture_step2i_followupwindow300_payloadelevate_20260628"
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step2i_followupwindow300_payloadelevate_20260628",
