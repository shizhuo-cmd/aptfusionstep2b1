...
REUSED_SOURCE_ROOT = (
    REPO_ROOT
    / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_worktree_replay_from_module3_e3gt_plus240_gtonly_20260624"
)
TARGET_ROOT = (
    REPO_ROOT
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "trace_behavior_capture_step3b_payloadtimelinepriv_20260626"
