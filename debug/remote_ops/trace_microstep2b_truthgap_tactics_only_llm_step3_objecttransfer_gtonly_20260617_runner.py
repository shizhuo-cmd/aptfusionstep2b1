...
CONFIG_PATH = Path(
    "configs/fusion_cloud_trace_train_stats_latefusion_bonus1_llama31_microstep2b_truthgap_tactics_only_llm_step3_objecttransfer_gtonly_20260617.yaml"
)
REUSED_SOURCE_ROOT = (
    REPO_ROOT / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_deterministic_gtonly_20260608"
)
...
def main() -> None:
    ...
    can_continue_to_step4 = not gate_failures
