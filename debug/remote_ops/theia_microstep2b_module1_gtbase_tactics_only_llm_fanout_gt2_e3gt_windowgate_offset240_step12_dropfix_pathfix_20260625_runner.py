...
REUSED_SOURCE_ROOT = (
    ...
    / (
        ...
        "e3gt_offset240_step12_dropfix_pathfix_20260625"
    )
)
TARGET_ROOT = (
    REPO_ROOT
    / (
        ...
        "fanout_gt2_e3gt_windowgate_offset240_step12_dropfix_pathfix_20260625"
    )
)
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "theia_behavior_capture_windowgate_step12_20260625"
