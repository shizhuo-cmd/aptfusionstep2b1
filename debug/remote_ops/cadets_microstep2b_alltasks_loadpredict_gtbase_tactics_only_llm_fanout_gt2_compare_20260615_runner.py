...
INCLUDE_CONFIG_PATH = Path(
    "configs/fusion_cloud_cadets_train_stats_latefusion_llama31_microstep2b_alltasks_loadpredict_gtbase_tactics_only_llm_fanout_gt2_include_segmented_20260615.yaml"
)
EXCLUDE_ROOT = REMOTE_REPO_ROOT / "artifacts_cadets_train_stats_latefusion_llama31_microstep2b_alltasks_loadpredict_gtbase_tactics_only_llm_fanout_gt2_exclude_segmented_20260615"
INCLUDE_ROOT = REMOTE_REPO_ROOT / "artifacts_cadets_train_stats_latefusion_llama31_microstep2b_alltasks_loadpredict_gtbase_tactics_only_llm_fanout_gt2_include_segmented_20260615"
OUTPUT_DIR = (
    REMOTE_REPO_ROOT
    / "debug"
    / "remote_ops"
    / "cadets_microstep2b_alltasks_loadpredict_gtbase_tactics_only_llm_fanout_gt2_compare_20260615_outputs"
)
...
def main() -> None:
    ...
    _write_json(
        comparison_summary_path,
        {
            ...
            "exclude_validation": exclude_summary.get("validation", {}),
            "include_validation": include_summary.get("validation", {}),
