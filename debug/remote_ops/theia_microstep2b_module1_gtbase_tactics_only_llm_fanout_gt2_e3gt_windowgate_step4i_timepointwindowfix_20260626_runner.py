...
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_theia_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_windowgate_step4i_timepointwindowfix_offset240_20260626"
)
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step4i_timepointwindowfix_evalonly",
        ...
        **reuse_provenance,
        ...
        "analysis_skipped": "space_saving_eval_only",
