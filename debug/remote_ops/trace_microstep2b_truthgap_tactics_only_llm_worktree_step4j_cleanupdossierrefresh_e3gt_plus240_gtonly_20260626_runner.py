...
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_worktree_step4j_cleanupdossierrefresh_e3gt_plus240_gtonly_20260626"
)
...
def _refresh_candidate_paths(cfg) -> dict[str, Any]:
    ...
    summary: dict[str, Any] = {"task_count": 0, "path_count": 0, "task_0345_path_001": {}}
    for source_file in sorted(source_dir.glob("*.json")):
        ...
        for payload in raw_items if isinstance(raw_items, list) else []:
            ...
            if path.path_id == "task_0345_path_001":
                summary["task_0345_path_001"] = {
...
def _focus_summary(cfg) -> dict[str, Any]:
    report_path = cfg.module6_reason_dir / "reports" / "task_0345_path_001.report.json"
