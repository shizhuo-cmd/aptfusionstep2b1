...
REUSED_SOURCE_ROOT = (
    REPO_ROOT
    / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_worktree_step3b_payloadtimelinepriv_e3gt_plus240_gtonly_20260626"
)
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_worktree_step3c_windowassign_e3gt_plus240_gtonly_20260626"
)
GT_JSON_PATH = resolve_attack_eval_gt_json(REPO_ROOT)
GT_TIME_OFFSET_MINUTES = 240
REUSED_DIR_NAMES = ["module3_evidence", "module4_compact", "module5_paths", "module6_reason"]
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "trace_behavior_capture_step3c_windowassign_20260626"
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step3c_windowassign_evalonly",
