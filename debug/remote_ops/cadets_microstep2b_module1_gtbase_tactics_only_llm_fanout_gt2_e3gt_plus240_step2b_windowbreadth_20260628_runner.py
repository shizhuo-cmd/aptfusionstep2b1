...
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_cadets_train_stats_latefusion_llama31_microstep2b_module1_gtbase_tactics_only_llm_fanout_gt2_e3gt_plus240_step2b_windowbreadth_20260628"
)
...
ANALYSIS_OUTPUT_DIR = REPO_ROOT / "debug" / "remote_ops" / "out" / "cadets_behavior_capture_step2b_windowbreadth_20260628"
...
def main() -> None:
    ...
    provenance = {
        "experiment_step": "step2b_windowbreadth_20260628",
