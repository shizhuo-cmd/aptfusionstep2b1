...
from replay_module6_from_llm_inputs_20260616 import replay_module6_reason


LOCAL_REPO_ROOT = Path(r"D:\daima\APT-Fusionstep2b1")
REPO_ROOT = Path("/root/autodl-tmp/APT-Fusionstep2b1")
CONFIG_PATH = Path(
    "configs/fusion_cloud_trace_train_stats_latefusion_bonus1_llama31_microstep2b_truthgap_tactics_only_llm_servicectx_gtonly_20260616.yaml"
)
BASELINE_ROOT = REPO_ROOT / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_ruletight1_gtonly_20260616"
...
def main() -> None:
    ...
    module6_outputs = replay_module6_reason(cfg, BASELINE_ROOT)
