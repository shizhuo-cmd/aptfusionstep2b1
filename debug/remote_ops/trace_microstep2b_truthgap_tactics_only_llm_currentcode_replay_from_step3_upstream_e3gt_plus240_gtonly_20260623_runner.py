...
TARGET_ROOT = (
    REPO_ROOT
    / "artifacts_trace_train_stats_latefusion_bonus1_microstep2b_truthgap_tactics_only_llm_currentcode_replay_from_step3_upstream_e3gt_plus240_gtonly_20260623"
)
